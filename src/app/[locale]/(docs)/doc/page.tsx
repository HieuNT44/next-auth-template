...
export default async function DocPage({ params }: DocPageProps) {
  ...
  return (
    <article className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <ul>
        <li>
          <Link href="/doc/installation" className="text-primary hover:underline">
            Installation
          </Link>{" "}
          - Set up the project locally
        </li>
        <li>
          <a href="/doc/auth/overview">Authentication Overview</a> - Configure
          auth providers
        </li>
        <li>
          <a href="/doc/guides/i18n">Internationalization Guide</a> - Add more
          languages
        </li>
      </ul>
    </article>
