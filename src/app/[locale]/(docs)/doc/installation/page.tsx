...
yarn install`}</code>
      ...
      <ul>
        <li>
          <a href="/doc">Introduction</a> - Overview of the template
        </li>
        <li>
          <a href="/doc/auth/overview">Authentication</a> - Configure auth
          providers
        </li>
        <li>
          <a href="/doc/guides/i18n">Internationalization</a> - Add more
          languages
        </li>
      </ul>
    </article>
